...
{
	partial class UCPregledTematskihCjelinaStudent
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "PREGLED TEMATSKIH CJELINA STUDENT";
			// 
			// UCPregledTematskihCjelinaStudent
			// 
			...
			this.Name = "UCPregledTematskihCjelinaStudent";
