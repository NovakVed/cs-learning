...
{
	partial class UCPregledTematskihCjelinaProfesor
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "PREGLED TEMATSKIH CJELINA";
			// 
			// UCPregledTematskihCjelinaProfesor
			// 
			...
			this.Name = "UCPregledTematskihCjelinaProfesor";
